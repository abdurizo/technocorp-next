                    ...
                    <div className={styles.modalContent}>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
                            ...
                            <div className={styles.block}>
                                <label htmlFor="name" className={classN(styles.label, styles.form_text_style)}>Ism</label>
                            ...
                            <div className={styles.block}>
                                <label htmlFor="tel" className={classN(styles.label, styles.form_text_style)}>Telefon raqamingizni toliq kiriting</label>
                                <div className={styles.input_wrap}>
                                    <span  >
                                        <Image
                                            src={Phone}
